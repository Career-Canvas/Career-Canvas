        ...
        <CardContent className="p-6">
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg shadow-sm">
              <div>
                <Label htmlFor="subject-0" className="text-sm font-medium text-gray-700">Subject 1 (Maths/Maths-Lit)</Label>
                <select
                  id="subject-0"
              ...
              <div>
                <Label htmlFor="percentage-0" className="text-sm font-medium text-gray-700">Percentage</Label>
                <Input
                  id="percentage-0"
                  type="number"
                  min="0"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg shadow-sm">
              <div>
                <Label htmlFor="subject-1" className="text-sm font-medium text-gray-700">Subject 2 (Life Orientation)</Label>
                <select
                  id="subject-1"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg shadow-sm">
              ...
              <div>
                <Label htmlFor="percentage-2" className="text-sm font-medium text-gray-700">Percentage</Label>
                <Input
                  id="percentage-2"
                  type="number"
                  min="0"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg shadow-sm">
              <div>
                <Label htmlFor="subject-3" className="text-sm font-medium text-gray-700">Subject 4 (First Additional Language)</Label>
                <select
                  id="subject-3"
              ...
              <div>
                <Label htmlFor="percentage-3" className="text-sm font-medium text-gray-700">Percentage</Label>
                <Input
                  id="percentage-3"
                  type="number"
                  min="0"
            ...
            {[4, 5, 6].map((index) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg shadow-sm">
                <div>
                  <Label htmlFor={`subject-${index}`} className="text-sm font-medium text-gray-700">Subject {index + 1} (Other)</Label>
                  <select
                    id={`subject-${index}`}
                ...
                <div>
                  <Label htmlFor={`percentage-${index}`} className="text-sm font-medium text-gray-700">Percentage</Label>
                  <Input
                    id={`percentage-${index}`}
                    type="number"
                    min="0"
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              {apsResults.wits !== null && (
                <div className="p-6 bg-gray-100 rounded-lg shadow-sm text-center">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Wits APS</h3>
                  <div className="text-4xl font-bold text-gray-800">{apsResults.wits}</div>
                </div>
              )}
              {apsResults.uj !== null && (
                <div className="p-6 bg-red-50 rounded-lg shadow-sm text-center">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">UJ APS</h3>
                  <div className="text-4xl font-bold text-red-600">{apsResults.uj}</div>
                </div>
              )}
              {apsResults.up !== null && (
                <div className="p-6 bg-green-50 rounded-lg shadow-sm text-center">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">UP APS</h3>
